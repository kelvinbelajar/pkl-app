...
@section('content')
    ...
    <div class="content">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('projects.create') }}" type="button" class="btn btn-primary mb-3">Tambah Data</a>
                <a href="{{ route('cetakProject') }}" target="_blank" type="button" class="btn btn-success mb-3"><i
                ...
                <form action="{{ route('cetakMonthlyProjects') }}" target="_blank" method="GET" class="form-inline mb-3">
                ...
                <table id="projects" class="table table-bordered table-striped mb-3">
                    <thead>
                        <tr align="center">
                            <th>NO</th>
                            <th>Project Name</th>
                    ...
                    <tbody>
                        @foreach ($projects as $data)
                            <tr align="center">
                                ...
                                <td>
                                    <a href="{{ route('projects.show', $data->id) }}"> <button class="btn btn-light m-2"><i
                                                class="bi bi-eye-fill"></i></button></a>
                                    <a href="{{ route('projects.edit', $data->id) }}"> <button
                                            class="btn btn-secondary m-2"><i class="bi bi-pencil-square"></i></button></a>
                                    <a href="{{ route('cetakProjectById', $data->id) }}" target="_blank" type="button"
