...
@section('judul_halaman', 'EDIT BUDGETING INFO')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Edit Budgeting Info</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="total_budget" id="total_budget"
                    placeholder="Add Total Budget" autocomplete="off" value="{{ $data->total_budget }}">
                  @error('total_budget')
                    <div class="alert alert-danger mt-2">
                      {{ $message }}
                    </div>
