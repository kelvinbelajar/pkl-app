...
@section('judul_halaman', 'EDIT PROJECT MANAGER')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Edit Project Manager</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="manager_name" id="manager_name"
                    placeholder="Add manager Name" autocomplete="off" value="{{ $data->manager_name }}">
                  @error('manager_name')
                    <div class="alert alert-danger mt-2">
                      {{ $message }}
                    </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="manager_contact" id="manager_contact"
                    placeholder="Add Manager Email" autocomplete="off" value="{{ $data->manager_contact }}">
