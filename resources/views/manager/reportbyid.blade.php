    ...
    @foreach ($managers as $data)
      <table class="table">
        ...
        <tr>
          ...
          <td>:</td>
          <td class="text-center align-middle">{{ $data->manager_name }}</td>
        </tr>
        <tr>
          <th class="text-center align-middle">Manager Contact</th>
          <td>:</td>
          <td class="text-center align-middle">{{ $data->manager_contact }}</td>
        </tr>
      </table>
