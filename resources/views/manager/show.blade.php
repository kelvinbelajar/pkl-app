              ...
              @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="manager_name" id="manager_name"
                    placeholder="Add manager Name" autocomplete="off" value="{{ $data->manager_name }}" readonly>
                  @error('manager_name')
                    <div class="alert alert-danger mt-2">
                      {{ $message }}
                    </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="manager_contact" id="manager_contact"
                    placeholder="Add Manager Contact" autocomplete="off" value="{{ $data->manager_contact }}" readonly>
