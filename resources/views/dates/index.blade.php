...
@section('content')
    ...
    <div class="content">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('dates.create') }}" type="button" class="btn btn-primary mb-3">Tambah Data</a>
                <a href="{{ route('cetakDate') }}" target="_blank" type="button" class="btn btn-success mb-3"><i
                ...
                <form action="{{ route('cetakMonthlyDates') }}" target="_blank" method="GET" class="form-inline mb-3">
                ...
                <table id="dates" class="table table-bordered  table-striped mb-3">
                    <thead>
                        <tr align="center">
                            <th>NO</th>
                            <th>Project</th>
                    ...
                    <tbody>
                        @foreach ($dates as $data)
                            <tr align="center">
                                ...
                                <td>
                                    <a href="{{ route('dates.show', $data->id) }}"> <button class="btn btn-light m-2"><i
                                                class="bi bi-eye-fill"></i></button></a>
                                    <a href="{{ route('dates.edit', $data->id) }}"> <button
                                            class="btn btn-secondary m-2"><i class="bi bi-pencil-square"></i></button></a>
                                    <a href="{{ route('cetakDateById', $data->id) }}" target="_blank" type="button"
                                        class="btn btn-success m-2"><i class="bi bi-printer"></i></a>
                                    <form action="{{ route('dates.destroy', $data->id) }}" method="POST"
