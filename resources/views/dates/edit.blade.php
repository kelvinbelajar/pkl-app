...
@section('judul_halaman', 'EDIT PROJECT DATE')
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="start_project" id="start_project"
                      placeholder="Add Start Date" autocomplete="off" value="{{ $data->start_project }}">
                    @error('start_project')
                      <div class="alert alert-danger mt-2">
                        {{ $message }}
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="end_project" id="end_project"
                      placeholder="Add End Date" autocomplete="off" value="{{ $data->end_project }}">
                    @error('end_project')
                      <div class="alert alert-danger mt-2">
                        {{ $message }}
                      </div>
