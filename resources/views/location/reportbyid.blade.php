...
<head>
  ...
  <style type="text/css" media="print">
    @page {
      size: auto;
      margin: 10mm; /* Adjusted margin to fit more content */
    }
  </style>
  <style>
    body {
    ...
    .sheet {
      padding: 10mm; /* Adjusted padding to maximize space */
      position: relative;
    ...
    .signature-section {
      margin-top: 10px; /* Adjusted margin to fit the signature on the page */
    }
...
<body>
  <section class="sheet">
    ...
    <h1 style="text-align: center;">LAPORAN DATA MANAGER</h1>
    ...
    @foreach ($locations as $data)
      <table class="table">
        ...
        <tr>
          ...
          <td>:</td>
          <td class="text-center align-middle">{{ $data->provinsi_name }}</td>
        </tr>
        <tr>
          <th class="text-center align-middle">Kota</th>
          <td>:</td>
          <td class="text-center align-middle">{{ $data->kota_name }}</td>
        </tr>
        <tr>
          <th class="text-center align-middle">Kecamatan</th>
          <td>:</td>
          <td class="text-center align-middle">{{ $data->kecamatan_name }}</td>
        </tr>
        <tr>
          <th class="text-center align-middle">Kelurahan</th>
          <td>:</td>
          <td class="text-center align-middle">{{ $data->kelurahan_name }}</td>
        </tr>
        <tr>
