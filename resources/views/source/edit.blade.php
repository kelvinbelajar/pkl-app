...
@section('judul_halaman', 'EDIT SOURCE FUNDS')
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Edit Source Funds</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="source_name" id="source_name"
                    placeholder="Add Organization Name" autocomplete="off"  value="{{ $data->source_name }}">
                  @error('source_name')
                    <div class="alert alert-danger mt-2">
                      {{ $message }}
                    </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="source_manager" id="source_manager"
                    placeholder="Add Organization Manager Name" autocomplete="off"  value="{{ $data->source_manager }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="source_email" id="source_email"
                    placeholder="Add Source Organization Email" autocomplete="off"  value="{{ $data->source_email }}">
                  @error('source_email')
                    <div class="alert alert-danger mt-2">
                      {{ $message }}
                    </div>
